...
modDatetime: 2026-03-15T09:30:52+08:00
slug: to-do-list
featured: false
draft: false
tags:
...
現行的法律系統筆者認為仍不臻完美，還有一系列的改裝目標想要完成，這些目標現在都乖乖躺在筆者的Google Keep內。<!-- 總有一天，一定會把他們全部實裝的！各位等我！ -->

礙於時間與技術都不足，雖有如此宏大的目標，也很難一蹵而就。但是，我們也可以先階段性地完成這些目標，愈挫愈勇，時候到了，Google Keep內的酷東西總會更新上來的。
...
<!-- 沒事！愈挫愈勇，時候到了，Google Keep內的酷東西總會更新上來的。 -->
<!-- ，我們學測後見！ -->
...
> 2026.03.15按：維護手冊不僅有了，還簡化很多！（因為升級到Astro了）
...
> 2026.03.15按：遷移到Asrto的過程中，烤吐司通知被犧牲掉了。但目前看來狀況還好，再觀察看看。
...
- [x] ~~**短期目標**：改用靜態網站生成器~~
- [ ] **中期目標**：製作成各校可直接fork走的template repo
- [ ] **長期目標**：網站上面寫的那個
